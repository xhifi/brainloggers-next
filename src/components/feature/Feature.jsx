  ...
  return (
    <div className="flex flex-wrap items-center gap-16 lg:flex-nowrap lg:gap-20">
      <ContentContainer>
        ...
        <p className="text-lg">
          Step up and pioneer with our devoted teams. We help you assemble your
          own remote, dedicated development squads, carefully curated to meet
        ...
        <p className="text-lg">
          ...
          synergistically in a team or independently, as per your requirements.
        </p>
      </ContentContainer>
